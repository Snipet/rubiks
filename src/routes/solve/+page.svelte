...
<div class="page page--wide">
	<header class="head">
		...
		<h1>What should I do with this cube?</h1>
		<p class="lede">
			Set the cube below to match the one in your hands — paint the stickers, or type the scramble
			you used — and you will get advice for where you actually are, at the level you are actually
			at. Nothing is sent anywhere; all of this runs in your browser.
		</p>
	</header>
	...
	<div class="layout">
		...
		<section class="panel" aria-label="Advice" aria-live="polite">
				...
				<div class="status status--bad">
					...
					{#if countUnset(facelets) === 0}
						<p class="status__aside">
							...
							which means the cube was taken apart, or one sticker has been read wrong. It is nearly
							always the latter.
						</p>
					{/if}
				</div>
			...
			<details class="raw">
				...
				<p class="raw__note">
					Fifty-four letters, in the order up, right, front, down, left, back. Each letter names the
					face whose colour that sticker carries.
				</p>
			</details>
		</section>
	</div>
